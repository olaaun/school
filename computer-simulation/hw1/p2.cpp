...
int next_event_type, num_custs_delayed, num_delays_required, num_events,
    num_in_q, server_status, queue_limit, num_custs_blocked, arrivals;
...
{
        num_delays_required = 200;
        mean_service = 1;
        mean_interarrival = 0.85;
